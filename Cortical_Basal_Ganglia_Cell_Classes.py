...
class STN_Neuron_Type(NativeCellType):
	...
	recordable =['soma(0.5).ica_stn','soma(0.5).ik_stn','soma(0.5).ina_stn', 'soma(0.5).ikD_stn', 'soma(0.5).ikA_stn', 'soma(0.5).ikAHP_stn', 'soma(0.5).icaT_stn', 'soma(0.5).icaL_stn', 'soma(0.5).ilk_stn', 'soma(0.5).v', 'AMPA.i', 'GABAa.i', 'soma(0.5).nai', 'soma(0.5).nao','soma(0.5).ki','soma(0.5).ko','soma(0.5).cai','soma(0.5).cao','soma(0.5).eca','soma(0.5).ek','soma(0.5).ena','soma(0.5).ica',]
	units = {'soma(0.5).ica_stn': 'nA','soma(0.5).ik_stn': 'nA','soma(0.5).ina_stn': 'nA', 'soma(0.5).ikD_stn': 'nA', 'soma(0.5).ikA_stn': 'nA', 'soma(0.5).ikAHP_stn': 'nA', 'soma(0.5).icaT_stn': 'nA', 'soma(0.5).icaL_stn': 'nA', 'soma(0.5).ilk_stn': 'nA', 'soma(0.5).v': 'mV', 'AMPA.i': 'nA', 'GABAa.i': 'nA', 'soma(0.5).nai': '0.001/liter', 'soma(0.5).nao': '0.001/liter', 'soma(0.5).ki': '0.001/liter', 'soma(0.5).ko': '0.001/liter', 'soma(0.5).cai': '0.001/liter', 'soma(0.5).cao': '0.001/liter', 'soma(0.5).eca': 'mV', 'soma(0.5).ek': 'mV', 'soma(0.5).ena': 'mV', 'soma(0.5).ica_stn': 'nA', }
